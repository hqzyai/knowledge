...
type CreateKnowledgeQARequest struct {
	...
	SummaryModelID        string                       `json:"summary_model_id"`                      // Optional persisted summary model ID for this request
	ChatModel             *types.RequestChatModel      `json:"chat_model,omitempty"`                  // Ephemeral OpenAI-compatible model for machine callers
