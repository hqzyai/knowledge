...
type UserService interface {
	...
	// ProvisionExternalUser idempotently creates an externally managed user in
	// an existing tenant and ensures an active Contributor membership.
	ProvisionExternalUser(ctx context.Context, req *types.ExternalUserCreateRequest, tenantID uint64) (*types.User, bool, error)
