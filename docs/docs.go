    ...
    "definitions": {
        ...
        "github_com_Tencent_WeKnora_internal_types.TenantSandboxConfig": {
            ...
            "properties": {
                ...
                "sandbox_type": {
                    "description": "SandboxType selects the sandbox backend. Named configs must set it to\n\"cube\" or \"e2b\"; \"docker\", \"local\" and \"disabled\" appear only on the\nworkspace policy row.",
                    "type": "string"
                },
                "volume_mount": {
