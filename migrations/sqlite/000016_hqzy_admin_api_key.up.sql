-- SQLite mirror of 000094_hqzy_admin_api_key. The application fills this
-- seed from WEKNORA_BOOTSTRAP_ADMIN_API_KEY through the AES model hook at startup.
...
SELECT
    ...
    'bootstrap-hqzy-admin-pending', '', TRUE, '[]', '[]'
WHERE EXISTS (
