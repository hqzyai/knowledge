...
const exampleData: FAQEntryPayload[] = [
  {
    standard_question: '什么是 华清智言知识库？',
    answers: ['华清智言知识库 是一个智能知识库管理系统', '它支持多种知识库类型和导入方式'],
    similar_questions: ['华清智言知识库 是什么？', '介绍一下 华清智言知识库'],
    negative_questions: ['这不是 华清智言知识库', '与 华清智言知识库 无关'],
    tag_name: '产品介绍',
  },
  {
